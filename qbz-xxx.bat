...
echo.
echo Увага... З 2024.01.15 скрипт більше не буде оновлюватися бо Qobuz змінив метод авторизації і на данний момент жоден завантажувач командного рядка не може працювати з новим API. Як тільки знайдеться інший робочий спосіб завантаження з qobuz.com то скрипт буде оновлено до актуального стану, а поки що раджу використовувати сервіс онлайн завантаження
